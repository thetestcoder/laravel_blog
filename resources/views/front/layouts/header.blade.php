...
<head>
    ...
    <link rel=stylesheet href='{{asset('front/')}}/plugins/goodlayers-core/plugins/combine/style.css' type=text/css
          media=all>
    <link rel=stylesheet href='{{asset('front/')}}/plugins/goodlayers-core/include/css/page-builder.css' type=text/css
          media=all>
    <link rel=stylesheet href='{{asset('front/')}}/plugins/revslider/public/assets/css/settings.css' type=text/css
          media=all>
    ...
    <link href="{{asset('back/')}}/vendor/mdi-font/css/material-design-iconic-font.min.css" rel="stylesheet"
          media="all">
    ...
    <link href="{{asset('back/')}}/vendor/bootstrap-progressbar/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet"
          media="all">
                                    ...
                                    <li class="menu-item menu-item-home current-menu-item"><a href=index.html
                                        ...
                                        <ul class=sub-menu>
                                            <li class="menu-item menu-item-home current-menu-item "><a
                                                    href={{route('homepage')}} aria-current=page>Anasayfa</a></li>
                                        </ul>
                                    </li>
                ...
                <div class="akea-header-container-inner clearfix">
                    <div class="akea-navigation akea-item-pdlr clearfix ">
                        <div class=akea-main-menu id=akea-main-menu>
                            <ul id=menu-main-navigation-1 class=sf-menu>
                                <li class="menu-item menu-item-home current-menu-item akea-normal-menu"><a
                                        href={{route('homepage')}} class=sf-with-ul-pre>Anasayfa</a>

                                </li>
                                <li class="menu-item menu-item-has-children akea-normal-menu"><a href=#
                                                                                                 class=sf-with-ul-pre>Kategoriler</a>
                                    <ul class=sub-menu>
                                ...
                                <li class=akea-center-nav-menu-item>
                                    ...
                                    <div class="akea-logo  akea-item-pdlr">
                                        <div class=akea-logo-inner>
                                            <a class href=index.html><img src=upload/logo-2-1.png alt width=140
                                                                          height=33 title=logo-2></a>
                                        </div>
                                    </div>
                                </li>
                                <li class="menu-item menu-item-has-children akea-normal-menu"><a href=#
                                                                                                 class=sf-with-ul-pre>Sayfalar</a>
                                    <ul class=sub-menu>
                                        @foreach($pages as $page)
                                            <li class="menu-item akea-normal-menu"><a
                                                    href={{route('page', $page->slug, ['id' => '1'])}}>{{$page->title}}</a>
                                            </li>
                                        @endforeach()
                                    </ul>
                        ...
                        <div
                            ...
                            <a href={{$setting->twitter ?? ''}} target=_blank class=akea-top-bar-social-icon
                               title=twitter>
                                <i class="fa fa-twitter"></i>
                            </a>
                            <a href="{{$setting->github ?? ''}}" target=_blank class=akea-top-bar-social-icon
                               title=github>
                                <i class="fa fa-github"></i>
                            </a>
                            <a href={{$setting->linkedin ?? ''}} target=_blank class=akea-top-bar-social-icon
                               title=linkedin>
                                <i class="fa fa-linkedin"></i>
                            </a>
                            <a href={{$setting->medium ?? ''}} target=_blank class=akea-top-bar-social-icon
                               title=medium>
