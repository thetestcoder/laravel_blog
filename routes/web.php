...
// User Login Route
Route::post('/user-login', [\App\Http\Controllers\Front\UserController::class, 'myprofile_post'])->name('user.login');
// User View
Route::middleware('auth')->prefix('myuser')->name('myuser.')->group(function () {
